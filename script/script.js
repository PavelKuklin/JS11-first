const dnkToRnk = function(text) {
    let array = [...text];
    console.log(array);
    let newRnk = '';
    for (let key of array) { // В условиях конкретно большой регистр. Можно сделать перевод через //toUpperCase, но на всякий случай делать не стал.
        if (key === 'A') {
            newRnk += 'U';
        } else if (key === 'T') {
            newRnk += 'A';
            ...
            newRnk = 'Ошибка, вы ввели неверные данные.'
            break;
        }
